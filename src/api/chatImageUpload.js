...
function uploadMyChatImage(tempFilePath) {
  ...
  return new Promise((resolve, reject) => {
    uni.uploadFile({
      url: `${API_BASE_URL}/me/chat-images`,
...
/** 小程序：选图后 multipart 上传，返回 { imageUrl } */
export function uploadChatImage(tempFilePath) {
  if (getMockEnabled()) {
    return Promise.resolve({ imageUrl: tempFilePath })
  }
  return uploadMyChatImage(tempFilePath)
}
